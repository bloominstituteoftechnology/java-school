...
public class StudentController
{
    ...
    public ResponseEntity<?> listAllStudents(@PageableDefault(page = 0, size = 1)Pageable pageable)
    {
        List<Student> myStudents = studentService.findAll(pageable);
        return new ResponseEntity<>(myStudents, HttpStatus.OK);
    }
    @ApiOperation(value = "Retrieves student by student Id", response = Student.class)
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> getStudentById(@ApiParam(value = "StudentId")
            @PathVariable
                    Long StudentId)
    {
    ...
    @ApiOperation(value = "Creates A New Student", notes = "The Newly Created Student ID Will Be Sent To The Location Header", response = void.class)
    @ApiResponses(value = {
